...
class SemesterScheduleTest {
    ...
    void testToString() {
        ...
        Course course1 = new Course("Underwater basket weaving", "HUMA 201", meetings1, "A good class", "STEM 376", "Dr. Bibza", 3, null);

        LocalDateTime time2 = LocalDateTime.of(2024, 1, 1, 14, 0);
        LocalDateTime[][] meetings2 = {null, {time2, time2}, null, {time2, time2}, null};
        Course course2 = new Course("Foundations of balloon fabrication", "HUMA 301", meetings2, "A better class", "HAL 116", "Dr. Bibza", 3, null);
